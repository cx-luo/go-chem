...
// Windows platforms
#cgo windows,amd64 LDFLAGS: -L../lib/windows-x86_64 -lindigo -lindigo-inchi
#cgo windows,386 LDFLAGS: -L../lib/windows-i386 -lindigo -lindigo-inchi

// Linux platforms
#cgo linux,amd64 LDFLAGS: -L../lib/linux-x86_64 -lindigo -lindigo-inchi -Wl,-rpath,$ORIGIN/../lib/linux-x86_64
#cgo linux,arm64 LDFLAGS: -L../lib/linux-aarch64 -lindigo -lindigo-inchi -Wl,-rpath,$ORIGIN/../lib/linux-aarch64

// macOS platforms
#cgo darwin,amd64 LDFLAGS: -L../lib/darwin-x86_64 -lindigo -lindigo-inchi -Wl,-rpath,@loader_path/../lib/darwin-x86_64
#cgo darwin,arm64 LDFLAGS: -L../lib/darwin-aarch64 -lindigo -lindigo-inchi -Wl,-rpath,@loader_path/../lib/darwin-aarch64
